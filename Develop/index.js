// Included packages required for this app
...
// Created function to init app 
function init() {
    inquirer.prompt(questions)
    .then((data) => {
        const readmeInfo = generateMarkdown(data);
    // Then to write README file with an error message for not saving the file
